...
export function About() {
  ...
  return (
    ...
    >
      <div
        ref={headRef}
        className="px-6 md:px-10 pt-32 md:pt-44 pb-20 md:pb-24"
      >
      ...
      >
        ...
        <div className="relative h-full text-white about-stage-content [mix-blend-mode:difference]">
          ...
          {/* Top progress bar */}
          <div className="absolute top-8 md:top-10 left-6 right-6 md:left-10 md:right-10 z-30">
            <div className="max-w-[1400px] mx-auto">
            ...
            <ul className="space-y-3.5 font-mono text-[0.7rem] uppercase tracking-[0.18em]">
              {CHAPTERS.map((c, i) => (
                ...
                >
                  ...
                  <span
                    className={`block h-px bg-current transition-all duration-500 ease-[var(--ease-out-quart)] ${
                      i === activeIdx ? 'w-12' : 'w-4'
                    }`}
                  />
                  <span>{c.label}</span>
                </li>
